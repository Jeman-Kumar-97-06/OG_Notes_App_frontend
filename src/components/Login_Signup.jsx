...
export default function AuthDialog() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-pink-50 to-purple-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6 transition-colors">
      {/* Dialog Box */}
      <div className="bg-white dark:bg-gray-800 w-full max-w-md rounded-2xl shadow-xl p-8 relative transition-colors">
        {/* Dark Mode Toggle */}
        <button
        ...
        <div className="flex flex-col items-center mb-6">
          <Notebook className="h-10 w-10 text-indigo-600 dark:text-indigo-400 mb-2" />
